...
import { AppLibraryStatus, AppLibraryType, NovelStatus, type AppLibrary, type AppLibraryDraft } from '../../shared/app-library';
...
export function seedLibrary(db: Db, type: AppLibraryType, overrides: Partial<AppLibraryDraft> = {}): AppLibrary {
  const draft: AppLibraryDraft = { title: 'Item', type, status: AppLibraryStatus.Draft, coverUrl: null, ...metadataFor(type), ...overrides };
