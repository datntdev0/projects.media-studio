...
# Everything the scraper writes or keeps between runs — the browser profile, the log —
# lives here, beside the code rather than wherever the caller happens to run it from.
